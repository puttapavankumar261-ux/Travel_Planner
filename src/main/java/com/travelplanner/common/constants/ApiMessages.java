package com.travelplanner.common.constants;
...
public final class ApiMessages {
    ...
    public static final String ITINERARY_CREATED = "Itinerary created successfully";
    ...
    public static final String EXPENSE_CREATED = "Expense added successfully";
    ...
    public static final String ACCOMMODATION_CREATED = "Accommodation added successfully";
    ...
    public static final String TRANSPORT_CREATED = "Transportation added successfully";
    ...
    public static final String ACTIVITY_CREATED = "Activity added successfully";
